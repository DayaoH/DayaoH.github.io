var $User = function () {
  ...
  return {
    ...
    Server: {
      List: [[$__language_Array__["ad474b5a21fcd3fd786fca906cbde045"], "http://pvz1.lonelystar.org/", "NaN"], [$__language_Array__["500f8e2d972e7946a85d0f15b32a251f"], "http://pvz2.lonelystar.org/", "NaN"], [$__language_Array__["0a9dfcd11bac3d3a4ea1ba21e65ea8ae"], "http://pvz3.lonelystar.org/", "NaN"], [$__language_Array__["3dcd38f392c7747083a1b1ed7e023fe0"], "http://pvz4.lonelystar.org/", "NaN"]],
      SpeedURL: "",
      DataURL: "",
      SpeedInx: 0,
      DataInx: 0,
    ...
    Visitor: {
      UserName: $__language_Array__["9c42018d42d0c4fb9eaa617a5c34aa9a"],
      UserAuthority: 0,
      Progress: 1,
      SelectServerT: 0,
      NowStep: 1,
    ...
    if (this.Timer == null) {
      (function () {
        ...
        try {
          ...
          alert($__language_Array__["68d51a683b6e8c3bf02fc16198c6add6"]);
          location.reload();
        }
  ...
  LoadTips: function () {
    var b = NewEle("dTips", "div", $__language_Array__["08b118c30581c2aebe418d5d17f585c2"], "", EDAll),
        a = [$__language_Array__["c423f99a1bd9ffb74373475204acd6ee"], $__language_Array__["61f9c2297c71b8780be257978c3dcb45"], $__language_Array__["1b2a27e4547c7261c8cc128291628a3b"], $__language_Array__["1a48d0ae150f51485707d3a5353b54c7"], $__language_Array__["48c4d3f8e80b8065eae088a95d07a2d5"], $__language_Array__["52f0d94922ee732785c75834579dba2f"], $__language_Array__["575f47710640f03979cdcd692982b2a3"], $__language_Array__["546111bd65cf77e6488eb601c5318e39"], $__language_Array__["b4405a61a25928a5a80b03b3e30bd672"]];
  ...
  LoadProgress: function (r, l, a, t, b) {
    ...
    p.PicNum = w += i.length;
    r = i.length;
    y.setAttribute("title", $__language_Array__["f6e634450a91a6c8672785d8c40d7c7c"]);
  ...
  CheckImg: function (b, a) {
    ...
    $("sFlagMeterTitleF").innerHTML = $__language_Array__["2f4a39950b9967cd1fb05a39a074d513"] + c.AccessNum + "/" + c.PicNum + ")</span>";
    ...
    if (c.AccessNum == c.PicNum) {
      ...
      if (c.MustAllReady) {
        $("sFlagMeterTitleF").innerHTML = $__language_Array__["b7c7ddc5bc0075b8abbc46885f0f0c5e"];
        c.LoadReady(c);
      }
    }
  },
  LoadReady: function (f) {
    ...
    if (f.CenterContent) {
      ...
      if (oS.MustAllReady && oS.DisplayAD) {
        ...
        if (b > 0) {
          ...
          (function (g) {
            var h = $("ADTimer");
            h && ($("ADTimer").innerHTML = $__language_Array__["4240f6c52f540d42247a39415837bbb7"] + g + $__language_Array__["67037fe9e3d1df620660d6759aa6e7fe"]);
    ...
    var d = function (h) {
      ...
      i.ShowScroll ? oSym.addTask(h == undefined ? 200 : h, function (j) {
        ClearChild(j);
        i.ScrollScreen();
      }, [NewEle("DivParty", "div", $__language_Array__["07dc9b8e47c1f2f043e33a782e4081a0"], {
        innerHTML: (Math.floor(g.UserAuthority) == "255" ? '<span style="color:#CE9A00;font-size:40px">&lt;' + g.UserName + "&gt;</span>" : "&lt;" + g.UserName + "&gt;") + $__language_Array__["cfff47f7a9c75a88e844fcc29571d6df"]
  ...
  Init: function (a) {
    ...
    a && a.FlagNum ? (r.FlagHeadStep = Math.floor(140 / (a.FlagNum - 1)), r.MonPrgs = function () {
      var u = oP,
          ...
          t,
          f = $User.Visitor;
      ! --u.NumZombies && (i < u.FlagNum ? (u.ReadyFlag = ++i, oSym.addTask(500, u.FlagPrgs, [])) : (u.FlagToEnd(), $User.isAuthorWebsite && $User.Visitor.UserName != $__language_Array__["85e068deeeef1d048bc430924c3ca109"] && (ClearChild($("JSPVZAjax")), f.SaveLvl && NewEle("JSPVZAjax", "script", 0, {
...
PZCard = {
  Init: function () {
    this.PData = {
      ...
      92: oXiaoLaserBean,
      'Bow_0': oNutBowling,
      'Bow_1': oHugeNutBowling,
      'Bow_2': oBoomNutBowling
    };
    this.ZData = {
      0: oZombie,
      1: oFlagZombie,
  ...
  trans: function (ar, inx, undefined) {
...
Almanac = {
  Init: function () {
    ...
    NewEle('dHandBook', 'div', 0, 0, document.body, {
      'class': 'WindowFrame'
    }).innerHTML = $__language_Array__["9d7cf4ca94ff4cca131b3c4da088e001"]; //植物和僵尸图鉴

    NewEle('dHandBookPZ', 'div', 0, 0, document.body, {
      'class': 'WindowFrame Almanac_PlantBack'
    }).innerHTML = $__language_Array__["6425c81feb57d18daaad0754365c9697"]; //生成初始界面的图鉴标签
  ...
  ViewHandBook: function () {
    if (!Almanac.isReady) {
      alert($User.Visitor.UserName == $__language_Array__["85e068deeeef1d048bc430924c3ca109"] ? $__language_Array__["17bba99285641f279eb7deaf2da7b7c3"] : $__language_Array__["6f027b54e22d65cd2e321a7c930b367d"]);
      return;
    }

    SetNone($('dOptionsMenubackShadow'), $('dOptionsMenuback'), $('dOptionsMenu'));
    oS.LvlEName ? (AllAudioPaused(), PlayAudio('gravebutton'), SetNone($('dSurface')), oSym.Stop(), innerText($('dMenu0'), $__language_Array__["b78649e341c98014bb8c716a32e1d094"]), $('dMenu1').onclick = null) : (AllAudioPaused(), PlayAudio('tap'));
  ...
  ViewProducePlant: function (o) {
    ...
    $('pHandBookPlant').style.backgroundPosition = '50% ' + (90 - (Pro.height + Pro.GetDTop) * .5) + 'px';
    $('dProducePlant').innerHTML = Pro.Produce;
    innerText($('dHandBookPlantName'), Pro.CName);
    innerText($('spSunNum'), Pro.SunNum);
    innerText($('spCoolTime'), Pro.coolTime + $__language_Array__["9f4565d5c70b4a24449ec3732bde808b"]);
  ...
  ViewProduceZombie: function (o) {
    ...
    $('pZombieBack').style.backgroundPosition = -200 * Pro.BookHandBack + 'px 0';
  },
  //返回图鉴索引
  ...
  Check: function (PAr, ZAr) {
    ...
    for (i = 0; i < l; i++) if (!isNaN(n = PAr[i]) && AlPInx.substr(n, 1) != 1) AlPInx = (n > 0 ? AlPInx.substr(0, n) : '') + 1 + AlPInx.substring(n + 1, Inx);
    ...
    for (i = 0; i < l; i++) if (!isNaN(n = ZAr[i]) && AlZInx.substr(n, 1) != 1) AlZInx = (n > 0 ? AlZInx.substr(0, n) : '') + 1 + AlZInx.substring(n + 1, Inx);
  ...
  var d = "",
      g,
      f,
      e = [oPeashooter, oSunFlower, oSnowPea, oFumeShroom, oStallia, oLavaGrava, oScaredyShroom, oFumeShroomSong, oTwinSunflower, oPuffShroom, oOxygen, oShuilei, oBubbleFlower, oThunderPine, oLitchi, oMagicShroom, oLaserBean, oFD, oBB, oBamboo, oCGTree, oLotus, oCactus, oPlantern, oGloomShroom, oaneone, oBlueBerry, oGarlic, oSquash, oRoseMan, oSpikerock, oPrimnalPea, oPrimnalNut, oColdnap, oShrubbery, oXiaoLaserBean, oPrimnalSun],
      a = e.length,
      b = 0,
      c;
  ...
  var d = "",
      g,
      f,
      e = [oSeaBasic, oSeaFlag, oSeaConch, oSeaShrimp, oSeaXie, oSeaGui, oSeaJelly, oJWZ, oJWC, oJWZG, oJWTA, oJWBT, oJWCG, oJWTSA, oJWBZ, oJWHX, oZombie, oConeheadZombie, oBucketheadZombie, osZombie, oscZombie, osbZombie, oSeagullZombie, oLostCityZombie, oJaneZombie],
      a = e.length,
      b = 0,
      c;
  ...
  innerText($("spCoolTime"), a.coolTime + $__language_Array__["9f4565d5c70b4a24449ec3732bde808b"]);
  ...
  var f = $("dTitle"),
      a = b.prototype;
  f.innerHTML = a.CName + $__language_Array__["3ebf0dce8f61bab566d55903aa1d7ed3"] + a.coolTime + $__language_Array__["4b49f55ee425162910c0a15dcc1db654"] + (oS.DKind && a.night ? $__language_Array__["fba263e9bb2ad8a7367e66ecc709e454"] + a.Tooltip : a.Tooltip || '<span style="text-align:left">' + a.Produce + "</span>");
  SetStyle(f, {
  ...
  var f = $("dTitle"),
      ...
      c = e.PName.prototype,
      a = c.CName;
  !oS.CardKind && (a += $__language_Array__["3ebf0dce8f61bab566d55903aa1d7ed3"] + c.coolTime + $__language_Array__["4b49f55ee425162910c0a15dcc1db654"] + c.Tooltip, !e.CDReady && (a += $__language_Array__["c62cf199586a43dcd31350cd38a5ed22"]));
  !e.SunReady && (a += $__language_Array__["1ee7252946548e10d0fb2ed2744d18d9"]);
  f.innerHTML = a;
  SetStyle(f, {
    top: 60 * b + "px",
  ...
  document.cookie = a + "=0;";
    ...
    WordUTF8 = '<div id="dLogo" style="position:absolute;width:900px;height:600px;z-index:1"><div id="LogoWord" style="position:absolute;color:#FF0;top:300px;width:100%;height:100px"><span style="position:absolute;width:105px;height:49px;left:285px;top:45px;cursor:pointer" onclick="PlayAudio(\'gravebutton\');SetBlock($(\'dSurface\'),$(\'iSurfaceBackground\'));ShowNameDiv()"></span><div style="position:absolute;font-size:14px;left:660px;text-align:center;width:140px;top:185px;line-height:1.5;font-weight:bold"><span style="cursor:pointer"><span id="sTime" style="cursor:pointer;color:#FFF">1.9.1</span></span></div></div><div style="position:absolute;width:74px;height:41px;left:807px;top:502px;cursor:pointer;z-index:300" onclick="SetVisible($(\'dProcess\'))"></div><img src="images/interface/bengji.gif" style="position:absolute;left:550px;top:-40px"></div>',
  ...
  confirm($__language_Array__["6b27fa6628503e31203a072dc1c84e35"] + b + $__language_Array__["802191a510b5d708529bcbdec42cc2bf"] + a + $__language_Array__["53b45a3b1e44085c02fc1499ba2beeb6"]) && (location.href = a);
},
    ShowLoginDiv = function () {
  $User.isAuthorWebsite ? (PlayAudio("tap"), SetBlock($("dLogin"))) : GotoAuthorWebsite($__language_Array__["020646b990fff9aa00adb5459c82d449"]);
},
    GameLogin = function (h) {
  if (!CheckLogin()) {
    return alert($__language_Array__["f3adb3bb7287b56e21088b114776db54"]);
  }
  ...
  if (!h && $("txtName").value == b.UserName) {
    return alert($__language_Array__["886f8eaa221b757fedcdac12b970484c"]);
  }
  ...
  ClearChild($("JSPVZAjax")), NewEle("JSPVZAjax", "script", 0, {
    ...
    type: "text/javascript"
  }, document.body), SetNone($("dLogin"));
  SetHidden($("dLoadUserName"));
  SetVisible($("dLoginButton"), $("dRegButton"));
  a.UserName = $__language_Array__["85e068deeeef1d048bc430924c3ca109"];
  a.UserAuthority = 0;
  a.Progress = 1;
  $("dName").innerHTML = $__language_Array__["683fbeeaf6462fa09ed00acc1288cf10"];
  ...
  if (g > 129) {
    alert($__language_Array__["3657d80c9c8991520c04d288e97037f0"]);
    return;
  }
  ...
  LoadLvl(g);
    ...
    InitGame = function () {
  var e = NewEle("dServer", "div", $__language_Array__["2e7f7cc5f9c9e90f737e15898d191aec"], 0, $("dAll")),
      c = $User.Server,
      b = c.List,
      a = $("dProcess2");
  !$("dText1") && a.insertBefore(NewEle("dText1", "div", 0, {
    innerHTML: $__language_Array__["1e64ae8f70fe794a1957ff758f8f6e95"]
  }, 0), a.firstChild);
  ...
  $("ChatView").src = b[c.DataInx][1] + "asp/ViewChat.asp"; //    e.innerHTML = (Number(c.SpeedInx) + 1) + "号服<br>" + (Number(c.DataInx) + 1) + "号服";
  ...
  var a = oSym;
  a.Start();
  innerText(b, $__language_Array__["9315338beb9e557f23c5b365df3822e0"]);
  ...
  AllAudioPaused();
  b.Stop();
  innerText(c, $__language_Array__["b78649e341c98014bb8c716a32e1d094"]);
  $("dMenu1").onclick = null;
  !a && SetBlock($("dSurface"), $("dPause"));
},
    ClickMenu = function () {
  oSym.Timer && (AllAudioPaused(), PlayAudio("pause"), oSym.Stop(), SetBlock($("dSurface")), innerText($("dMenu0"), $__language_Array__["b78649e341c98014bb8c716a32e1d094"]), ShowOptions());
},
  ...
  SetNone($("dRiddleInx"));
  SetBlock($("dRiddle0"));
  $("dRiddleTitle").innerHTML = $__language_Array__["d46ef131cce42868facf5a819a142549"];
},
    ShowRiddle1 = function () {
  $User.isAuthorWebsite ? (PlayAudio("gravebutton"), SetNone($("dRiddleInx")), SetBlock($("dRiddle1")), $("dRiddleTitle").innerHTML = $__language_Array__["9ee381b474bb8efec97147ad1c2ace6f"]) : GotoAuthorWebsite($__language_Array__["7b7bbb911e285cf878649d3b202c6b3b"]);
},
  ...
  $("dRiddleTitle").innerHTML = $__language_Array__["be16d6a5acd0f657ee54f9f463e8b95a"];
},
  ...
  oS.Lvl && (SetNone($("dSurface")), ResetGame($("dMenu0")));
    ...
    ViewHandBook = function () {
  SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
  oS.Lvl ? (AllAudioPaused(), PlayAudio("gravebutton"), SetNone($("dSurface")), oSym.Stop(), innerText($("dMenu0"), $__language_Array__["b78649e341c98014bb8c716a32e1d094"]), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio("tap"));
  PlayAudio("Look up at the Sky");
  SetVisible($("dHandBook"));
},
    ViewShowSkill = function () {
  SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
  oS.Lvl ? (AllAudioPaused(), PlayAudio("gravebutton"), SetNone($("dSurface")), oSym.Stop(), innerText($("dMenu0"), $__language_Array__["b78649e341c98014bb8c716a32e1d094"]), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio("tap"));
  PlayAudio("Look up at the Sky");
...
$SSml = function (d, c, a) {
  ...
  a.value == $__language_Array__["e2b323e92e16576496e2dec1c28b6818"] ? (SetBlock($("IF2"), $("dChatView")), a.value = $__language_Array__["2f4c5912327b2908adb9634de382b168"]) : (SetNone($("IF2"), $("dChatView")), a.value = $__language_Array__["e2b323e92e16576496e2dec1c28b6818"]);
};
