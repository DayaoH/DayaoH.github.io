var $User = function () {
  ...
  return {
    ...
    Server: {
      List: [[$__language_Array__["5e6d858d01f86080dcbbca3bc9d974ca"], "http://pvz1.lonelystar.org/", "NaN"], [$__language_Array__["24ecec2788201c87758f0469fe04eb9b"], "http://pvz2.lonelystar.org/", "NaN"], [$__language_Array__["c66b1a36549037afc298687e24393935"], "http://pvz3.lonelystar.org/", "NaN"], [$__language_Array__["1f29e1011bfd7d70b629953fea0869cb"], "http://pvz4.lonelystar.org/", "NaN"]],
      SpeedURL: "",
      DataURL: "",
      SpeedInx: 0,
      DataInx: 0,
    ...
    Visitor: {
      UserName: $__language_Array__["e77e91b616e4c997518508bfaa426125"],
      UserAuthority: 0,
      Progress: 1,
      SelectServerT: 0,
      NowStep: 1,
    ...
    if (this.Timer == null) {
      (function () {
        ...
        try {
          ...
          alert($__language_Array__["f6b56681e8deea79c2a47d3782a95aaa"]);
          location.reload();
        }
  ...
  LoadTips: function () {
    var b = NewEle("dTips", "div", $__language_Array__["43cb44ca96c5e1e57ad54ff0f253a472"], "", EDAll),
        a = [$__language_Array__["91b5524ea85d5d8b801f388e1f5c205e"]];
  ...
  LoadProgress: function (r, l, a, t, b) {
    ...
    p.PicNum = w += i.length;
    r = i.length;
    y.setAttribute("title", $__language_Array__["30702a5ebb7f096a8da9229fd3fe2911"]);
  ...
  CheckImg: function (b, a) {
    ...
    $("sFlagMeterTitleF").innerHTML = $__language_Array__["823ff3c0bb397aeef47ab9ace962c83c"] + c.AccessNum + "/" + c.PicNum + ")</span>";
    ...
    if (c.AccessNum == c.PicNum) {
      ...
      if (c.MustAllReady) {
        $("sFlagMeterTitleF").innerHTML = $__language_Array__["25270cea6db7bf9425e44b161d3f3225"];
        c.LoadReady(c);
      }
    }
  },
  LoadReady: function (f) {
    ...
    if (f.CenterContent) {
      ...
      if (oS.MustAllReady && oS.DisplayAD) {
        ...
        if (b > 0) {
          ...
          (function (g) {
            var h = $("ADTimer");
            h && ($("ADTimer").innerHTML = $__language_Array__["c7f70eb91cba2ea6972dc73e2bc44955"] + g + $__language_Array__["1b6c3eae1b3f5a0e5beff0bc612e1b9f"]);
    ...
    var d = function (h) {
      ...
      i.ShowScroll ? oSym.addTask(h == undefined ? 200 : h, function (j) {
        ClearChild(j);
        i.ScrollScreen();
      }, [NewEle("DivParty", "div", $__language_Array__["3985b69688f34ef367567aea7df347a7"], {
        innerHTML: (Math.floor(g.UserAuthority) == "255" ? '<span style="color:#CE9A00;font-size:40px">&lt;' + g.UserName + "&gt;</span>" : "&lt;" + g.UserName + "&gt;") + $__language_Array__["2d2efbd9c06ade28fde545a57480d26a"]
  ...
  Init: function (a) {
    ...
    a && a.FlagNum ? (r.FlagHeadStep = Math.floor(140 / (a.FlagNum - 1)), r.MonPrgs = function () {
      var u = oP,
          ...
          t,
          f = $User.Visitor;
      ! --u.NumZombies && (i < u.FlagNum ? (u.ReadyFlag = ++i, oSym.addTask(500, u.FlagPrgs, [])) : (u.FlagToEnd(), $User.isAuthorWebsite && $User.Visitor.UserName != $__language_Array__["725a42721772607c543421ecf6fec82d"] && (ClearChild($("JSPVZAjax")), f.SaveLvl && NewEle("JSPVZAjax", "script", 0, {
...
Almanac = {
  Init: function () {
    ...
    NewEle('dHandBook', 'div', 0, 0, document.body, {
      'class': 'WindowFrame'
    }).innerHTML = $__language_Array__["c7a8ace9bc22c82c0ab96e330f7adee2"]; //植物和僵尸图鉴

    NewEle('dHandBookPZ', 'div', 0, 0, document.body, {
      'class': 'WindowFrame Almanac_PlantBack'
    }).innerHTML = $__language_Array__["fceca08330ed8c8e2bc7948cec9cd2c2"]; //生成初始界面的图鉴标签
  ...
  ViewHandBook: function () {
    if (!Almanac.isReady) {
      alert($User.Visitor.UserName == $__language_Array__["725a42721772607c543421ecf6fec82d"] ? $__language_Array__["a79b8c7ddfdaf484dd040a12fecac119"] : $__language_Array__["1bb84ece5bf44071a007716f77dfe90b"]);
      return;
    }

    SetNone($('dOptionsMenubackShadow'), $('dOptionsMenuback'), $('dOptionsMenu'));
    oS.LvlEName ? (AllAudioPaused(), PlayAudio('gravebutton'), SetNone($('dSurface')), oSym.Stop(), innerText($('dMenu0'), $__language_Array__["6145bd993ba03240ab13134de5ed2b89"]), $('dMenu1').onclick = null) : (AllAudioPaused(), PlayAudio('tap'));
  ...
  ViewProducePlant: function (o) {
    ...
    innerText($('spCoolTime'), Pro.coolTime + $__language_Array__["26eb0f5f16cc70cef6bf7d496ece3abc"]);
  ...
  var d = "",
      g,
      f,
      e = [oSeaBasic, oSeaFlag, oSeaConch, oSeaShrimp, oSeaXie, oSeaGui, oSeaJelly, oJWZ, oJWC, oJWZG, oJWTA, oJWBT, oJWCG, oJWTSA, oJWBZ, oJWHX, oJWNZ, oDinoZombie, oDinoConeheadZombie, oDinoBucketheadZombie, oDinoTombZombie, oFutureZombie, oHeadZombie, oConeZombie, oDisco3000, oBackupDancer, oJetPack, oShield, oFutureBoss, oFirstKing_1, oFirstKing_2, oFirstKing_3, oFirstKing_4, oFirstKing_5, oFirstKing_6, oFirstKing_7, oFirstKing_8, oFirstKing_9, oFirstKing_10],
      a = e.length,
      b = 0,
      c;
  ...
  innerText($("spCoolTime"), a.coolTime + $__language_Array__["26eb0f5f16cc70cef6bf7d496ece3abc"]);
  ...
  var f = $("dTitle"),
      a = b.prototype;
  f.innerHTML = a.CName + $__language_Array__["ac54227ffd21afb61297800f62f1119b"] + a.coolTime + $__language_Array__["08a92e0ab105f860b96c0900223d762d"] + (oS.DKind && a.night ? $__language_Array__["d045113fed78bffbc9efb8397f8d6362"] + a.Tooltip : a.Tooltip || '<span style="text-align:left">' + a.Produce + "</span>");
  SetStyle(f, {
  ...
  var f = $("dTitle"),
      ...
      c = e.PName.prototype,
      a = c.CName;
  !oS.CardKind && (a += $__language_Array__["ac54227ffd21afb61297800f62f1119b"] + c.coolTime + $__language_Array__["08a92e0ab105f860b96c0900223d762d"] + c.Tooltip, !e.CDReady && (a += $__language_Array__["793e3c7c4ba27bcd429ae7a2b9df4fd4"]));
  !e.SunReady && (a += $__language_Array__["a484a0b53bc3352633d7c05dc5948d20"]);
  f.innerHTML = a;
  SetStyle(f, {
    top: 60 * b + "px",
...
ShowNameDiv = function () {
  ...
  confirm($__language_Array__["12aafcf6314f0638811a81754528c8c8"] + b + $__language_Array__["9aaf4d5cce3bae1a90965d40380bfdf5"] + a + $__language_Array__["cd8b5bebb10409f86082c7e995678db7"]) && (location.href = a);
},
    ShowLoginDiv = function () {
  $User.isAuthorWebsite ? (PlayAudio("tap"), SetBlock($("dLogin"))) : GotoAuthorWebsite($__language_Array__["80b98cdda181a11d4d5b680c45c3e432"]);
},
    GameLogin = function (h) {
  if (!CheckLogin()) {
    return alert($__language_Array__["e07e5709cfb05f350a611dba1c89717d"]);
  }
  ...
  if (!h && $("txtName").value == b.UserName) {
    return alert($__language_Array__["19728c098a88ad0c3bc6be8a1df2de44"]);
  }
  ...
  a.UserName = $__language_Array__["725a42721772607c543421ecf6fec82d"];
  a.UserAuthority = 0;
  a.Progress = 1;
  $("dName").innerHTML = $__language_Array__["08b837813f8cec41040943fcd5aded6b"];
  ...
  if (g > 129) {
    alert($__language_Array__["d6ae409ba78fc6d13f7d915c2201bfd7"]);
    return;
  }
  ...
  LoadLvl(g);
    ...
    InitGame = function () {
  var e = NewEle("dServer", "div", $__language_Array__["23e7be3ab2ed1d21de5817b72fe49f4e"], 0, $("dAll")),
      c = $User.Server,
      b = c.List,
      a = $("dProcess2");
  ...
  var a = oSym;
  a.Start();
  innerText(b, $__language_Array__["f5377e3c9b2f56fa8cb1e1be2c031a89"]);
  ...
  AllAudioPaused();
  b.Stop();
  innerText(c, $__language_Array__["6145bd993ba03240ab13134de5ed2b89"]);
  $("dMenu1").onclick = null;
  !a && SetBlock($("dSurface"), $("dPause"));
},
    ClickMenu = function () {
  oSym.Timer && (AllAudioPaused(), PlayAudio("pause"), oSym.Stop(), SetBlock($("dSurface")), innerText($("dMenu0"), $__language_Array__["6145bd993ba03240ab13134de5ed2b89"]), ShowOptions());
},
  ...
  SetNone($("dRiddleInx"));
  SetBlock($("dRiddle0"));
  $("dRiddleTitle").innerHTML = $__language_Array__["c806edb6b0468030ccf08de1230ec4f6"];
},
    ShowRiddle1 = function () {
  $User.isAuthorWebsite ? (PlayAudio("gravebutton"), SetNone($("dRiddleInx")), SetBlock($("dRiddle1")), $("dRiddleTitle").innerHTML = $__language_Array__["c968f8f88e416939fd8500ffb671dbbd"]) : GotoAuthorWebsite($__language_Array__["fb00ef54b15bcc9593109034830e4f78"]);
},
  ...
  $("dRiddleTitle").innerHTML = $__language_Array__["4c99ba441578bcaa8df181c2b19c44ad"];
},
  ...
  oS.Lvl && (SetNone($("dSurface")), ResetGame($("dMenu0")));
    ...
    ViewHandBook = function () {
  SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
  oS.Lvl ? (AllAudioPaused(), PlayAudio("gravebutton"), SetNone($("dSurface")), oSym.Stop(), innerText($("dMenu0"), $__language_Array__["6145bd993ba03240ab13134de5ed2b89"]), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio("tap"));
  PlayAudio("Look up at the Sky");
  SetVisible($("dHandBook"));
},
...
$SSml = function (d, c, a) {
  ...
  a.value == $__language_Array__["2bd4d1db023bbf00631ffbedaa3555be"] ? (SetBlock($("IF2"), $("dChatView")), a.value = $__language_Array__["f6b6eaa8d2c3d569a30f7454cff73ca0"]) : (SetNone($("IF2"), $("dChatView")), a.value = $__language_Array__["2bd4d1db023bbf00631ffbedaa3555be"]);
};
