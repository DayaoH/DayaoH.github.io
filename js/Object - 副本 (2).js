var $User = function () {
  ...
  return {
    ...
    Server: {
      List: [[$__language_Array__["e6ed72847f955272ff1685fdc9bac23b"], "http://pvz1.lonelystar.org/", "NaN"], [$__language_Array__["beb74515cacd31f8621f0bc59174fd00"], "http://pvz2.lonelystar.org/", "NaN"], [$__language_Array__["bd9026963fc8eb4b8205f968458bf945"], "http://pvz3.lonelystar.org/", "NaN"], [$__language_Array__["f09dd91a2b85b65ee7009387415771ff"], "http://pvz4.lonelystar.org/", "NaN"]],
      SpeedURL: "",
      DataURL: "",
      SpeedInx: 0,
      DataInx: 0,
    ...
    Visitor: {
      UserName: $__language_Array__["fa409930638f74542e7df45e8b6bb513"],
      UserAuthority: 0,
      Progress: 1,
      SelectServerT: 0,
      NowStep: 1,
    ...
    if (this.Timer == null) {
      (function () {
        ...
        try {
          ...
          alert($__language_Array__["51ce650de2d68883addae1f45f6bcac4"]);
          location.reload();
        }
  ...
  LoadTips: function () {
    var b = NewEle("dTips", "div", $__language_Array__["9714c1b50823788506f5ef8ec36264ad"], "", EDAll),
        a = [$__language_Array__["fe811a7a9c200c76bd2628d363597dad"]];
  ...
  LoadProgress: function (r, l, a, t, b) {
    ...
    p.PicNum = w += i.length;
    r = i.length;
    y.setAttribute("title", $__language_Array__["b81b7402267a4269a25b8f0562be9f60"]);
  ...
  CheckImg: function (b, a) {
    ...
    $("sFlagMeterTitleF").innerHTML = $__language_Array__["3f7ddf5dc7ca4228181b0503f1bebee2"] + c.AccessNum + "/" + c.PicNum + ")</span>";
    ...
    if (c.AccessNum == c.PicNum) {
      ...
      if (c.MustAllReady) {
        $("sFlagMeterTitleF").innerHTML = $__language_Array__["d51c7e355eea916f1e9390fefa9f16e4"];
        c.LoadReady(c);
      }
    }
  },
  LoadReady: function (f) {
    ...
    if (f.CenterContent) {
      ...
      if (oS.MustAllReady && oS.DisplayAD) {
        ...
        if (b > 0) {
          ...
          (function (g) {
            var h = $("ADTimer");
            h && ($("ADTimer").innerHTML = $__language_Array__["9ba2a0cf28e720757b1ab3a5f544ea6c"] + g + $__language_Array__["6127a5efb2eb1ea1cf73afe6eee73061"]);
    ...
    var d = function (h) {
      ...
      i.ShowScroll ? oSym.addTask(h == undefined ? 200 : h, function (j) {
        ClearChild(j);
        i.ScrollScreen();
      }, [NewEle("DivParty", "div", $__language_Array__["e247f00d62851e45e76e2c04a9d64160"], {
        innerHTML: (Math.floor(g.UserAuthority) == "255" ? '<span style="color:#CE9A00;font-size:40px">&lt;' + g.UserName + "&gt;</span>" : "&lt;" + g.UserName + "&gt;") + $__language_Array__["48481b4e47b1ed31e61bcf3cec0e457b"]
  ...
  Init: function (a) {
    ...
    a && a.FlagNum ? (r.FlagHeadStep = Math.floor(140 / (a.FlagNum - 1)), r.MonPrgs = function () {
      var u = oP,
          ...
          t,
          f = $User.Visitor;
      ! --u.NumZombies && (i < u.FlagNum ? (u.ReadyFlag = ++i, oSym.addTask(500, u.FlagPrgs, [])) : (u.FlagToEnd(), $User.isAuthorWebsite && $User.Visitor.UserName != $__language_Array__["866ae3f44ac09166f8a2958778b86b70"] && (ClearChild($("JSPVZAjax")), f.SaveLvl && NewEle("JSPVZAjax", "script", 0, {
...
Almanac = {
  Init: function () {
    ...
    NewEle('dHandBook', 'div', 0, 0, document.body, {
      'class': 'WindowFrame'
    }).innerHTML = $__language_Array__["8b01f2c17bca595cded3a5976804b6b3"]; //植物和僵尸图鉴

    NewEle('dHandBookPZ', 'div', 0, 0, document.body, {
      'class': 'WindowFrame Almanac_PlantBack'
    }).innerHTML = $__language_Array__["2f037ee279ccae8bc1f5d4770bd30615"]; //生成初始界面的图鉴标签
  ...
  ViewHandBook: function () {
    if (!Almanac.isReady) {
      alert($User.Visitor.UserName == $__language_Array__["866ae3f44ac09166f8a2958778b86b70"] ? $__language_Array__["e2f8cc0b4e8ae0282d9b259e5ac9348a"] : $__language_Array__["e3f546c6f5b8698ff7c755fe7e53b47d"]);
      return;
    }

    SetNone($('dOptionsMenubackShadow'), $('dOptionsMenuback'), $('dOptionsMenu'));
    oS.LvlEName ? (AllAudioPaused(), PlayAudio('gravebutton'), SetNone($('dSurface')), oSym.Stop(), innerText($('dMenu0'), $__language_Array__["e3feb50644d496c3aa517386435305eb"]), $('dMenu1').onclick = null) : (AllAudioPaused(), PlayAudio('tap'));
  ...
  ViewProducePlant: function (o) {
    ...
    innerText($('spCoolTime'), Pro.coolTime + $__language_Array__["69ea14ea4368b0a55bd0ea890ad57008"]);
  ...
  var d = "",
      g,
      f,
      e = [oSeaBasic, oSeaFlag, oSeaConch, oSeaShrimp, oSeaXie, oSeaGui, oSeaJelly, oJWZ, oJWC, oJWZG, oJWTA, oJWBT, oJWCG, oJWTSA, oJWBZ, oJWHX, oJWNZ, oZombie, oConeheadZombie, oBucketheadZombie, osZombie, oscZombie, osbZombie, oSeagullZombie, oLostCityZombie, oJaneZombie, oDinoZombie, oDinoConeheadZombie, oDinoBucketheadZombie, oDinoTombZombie, oFutureZombie, oHeadZombie, oConeZombie, oDisco3000, oBackupDancer, oJetPack, oShield, oFutureBoss, oFirstKing_1, oFirstKing_2, oFirstKing_3, oFirstKing_4, oFirstKing_5, oFirstKing_6, oFirstKing_8, oFirstKing_9],
      a = e.length,
      b = 0,
      c;
  ...
  innerText($("spCoolTime"), a.coolTime + $__language_Array__["69ea14ea4368b0a55bd0ea890ad57008"]);
  ...
  var f = $("dTitle"),
      a = b.prototype;
  f.innerHTML = a.CName + $__language_Array__["15ea36f7a57e5b9f1e0324338478ab40"] + a.coolTime + $__language_Array__["cb10f6e99d45e56361ab19c3ccf25684"] + (oS.DKind && a.night ? $__language_Array__["44752965765f1c61773054f621598871"] + a.Tooltip : a.Tooltip || '<span style="text-align:left">' + a.Produce + "</span>");
  SetStyle(f, {
  ...
  var f = $("dTitle"),
      ...
      c = e.PName.prototype,
      a = c.CName;
  !oS.CardKind && (a += $__language_Array__["15ea36f7a57e5b9f1e0324338478ab40"] + c.coolTime + $__language_Array__["cb10f6e99d45e56361ab19c3ccf25684"] + c.Tooltip, !e.CDReady && (a += $__language_Array__["6e4d26ef0edfd27ca77a742cc82694f6"]));
  !e.SunReady && (a += $__language_Array__["d5971a91808fe5fbbe0cdcd14d603e4b"]);
  f.innerHTML = a;
  SetStyle(f, {
    top: 60 * b + "px",
...
ShowNameDiv = function () {
  ...
  confirm($__language_Array__["25f6a6531c52475809854297ca0bfb57"] + b + $__language_Array__["b85006d62fa3890c23b9e0a8f1cd9200"] + a + $__language_Array__["39efaafa90e75760bbc7b69d4a641d8f"]) && (location.href = a);
},
    ShowLoginDiv = function () {
  $User.isAuthorWebsite ? (PlayAudio("tap"), SetBlock($("dLogin"))) : GotoAuthorWebsite($__language_Array__["28937bf42f4c5024687bbbfa7737b738"]);
},
    GameLogin = function (h) {
  if (!CheckLogin()) {
    return alert($__language_Array__["c5fe85164d66c3e0c6d2fc9399382e9a"]);
  }
  ...
  if (!h && $("txtName").value == b.UserName) {
    return alert($__language_Array__["a0d984da608d3ae94829b788504e6834"]);
  }
  ...
  a.UserName = $__language_Array__["866ae3f44ac09166f8a2958778b86b70"];
  a.UserAuthority = 0;
  a.Progress = 1;
  $("dName").innerHTML = $__language_Array__["8961aaf12da78abc274fb865e87bb0b1"];
  ...
  if (g > 129) {
    alert($__language_Array__["df675f7c308e283aebb00420609b7171"]);
    return;
  }
  ...
  LoadLvl(g);
    ...
    InitGame = function () {
  var e = NewEle("dServer", "div", $__language_Array__["08eda86fe257bd2bc92cbfc25298b0a7"], 0, $("dAll")),
      c = $User.Server,
      b = c.List,
      a = $("dProcess2");
  ...
  var a = oSym;
  a.Start();
  innerText(b, $__language_Array__["002f9ba4cdae7551e7a02c00811e0d70"]);
  ...
  AllAudioPaused();
  b.Stop();
  innerText(c, $__language_Array__["e3feb50644d496c3aa517386435305eb"]);
  $("dMenu1").onclick = null;
  !a && SetBlock($("dSurface"), $("dPause"));
},
    ClickMenu = function () {
  oSym.Timer && (AllAudioPaused(), PlayAudio("pause"), oSym.Stop(), SetBlock($("dSurface")), innerText($("dMenu0"), $__language_Array__["e3feb50644d496c3aa517386435305eb"]), ShowOptions());
},
  ...
  SetNone($("dRiddleInx"));
  SetBlock($("dRiddle0"));
  $("dRiddleTitle").innerHTML = $__language_Array__["dc19a5c30df5f81820bcb6f7062fb72d"];
},
    ShowRiddle1 = function () {
  $User.isAuthorWebsite ? (PlayAudio("gravebutton"), SetNone($("dRiddleInx")), SetBlock($("dRiddle1")), $("dRiddleTitle").innerHTML = $__language_Array__["c6232535672bbea9692b60357eb135d3"]) : GotoAuthorWebsite($__language_Array__["b406d8e3ae02d383365c4bdd1136b7e4"]);
},
  ...
  $("dRiddleTitle").innerHTML = $__language_Array__["bbc0f5fa17e37ccfbcb69aa3fccb7c73"];
},
  ...
  oS.Lvl && (SetNone($("dSurface")), ResetGame($("dMenu0")));
    ...
    ViewHandBook = function () {
  SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
  oS.Lvl ? (AllAudioPaused(), PlayAudio("gravebutton"), SetNone($("dSurface")), oSym.Stop(), innerText($("dMenu0"), $__language_Array__["e3feb50644d496c3aa517386435305eb"]), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio("tap"));
  PlayAudio("Look up at the Sky");
  SetVisible($("dHandBook"));
},
...
$SSml = function (d, c, a) {
  ...
  a.value == $__language_Array__["31b2c718cd4ffb108c5456594c75a368"] ? (SetBlock($("IF2"), $("dChatView")), a.value = $__language_Array__["801b306ecc097ab9effb96dc5c73da65"]) : (SetNone($("IF2"), $("dChatView")), a.value = $__language_Array__["31b2c718cd4ffb108c5456594c75a368"]);
};
