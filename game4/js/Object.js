...
var $User = (function () {
    ...
    e
      ...
      : (ShadowPNG = "exp/game4/images/interface/plantshadow32.png");
    return {
      Browser: {
        IE: c,
        IE6: e,
      ...
      Server: {
        List: [
          ["1号", "http://pvz1.lonelystar.org/", "NaN"],
          ["2号", "http://pvz2.lonelystar.org/", "NaN"]
        ],
        SpeedURL: "",
        DataURL: "",
        SpeedInx: 0,
  ...
  oS = {
    ...
    LoadTips: function LoadTips() {
      var b = NewEle(
        ...
        a = ["正在加载图片资源"];
      b.innerHTML =
        '<img src="exp/game4/images/interface/Flower.gif" style="position:absolute;top:0%;left:0%;transform:translateX(280px) translateY(-300px);pointer-events:none;"><span style="font-weight:bold"></span><span>' +
    ...
    LoadProgress: function LoadProgress(r, l, a, t, b) {
      ...
      NewImg(
        0,
        "exp/game4/images/interface/brain.png",
        "",
      ...
      switch (p.Coord) {
        case 2:
          NewImg(
            0,
            "exp/game4/images/interface/PoolCleaner.png",
            "",
        ...
        case 1:
          NewImg(
            0,
            "exp/game4/images/interface/LawnCleaner.png",
            "",
    ...
    LoadReady: function LoadReady(f) {
      ...
      var d = function d(h) {
        ...
        NewImg(
          "imgGrowSoil",
          "exp/game4/images/interface/GrowSoil.gif",
          "visibility:hidden;z-index:50",
          EDAll
        );
        NewImg(
          "imgGrowSpray",
          "exp/game4/images/interface/GrowSpray.gif",
          "visibility:hidden;z-index:50",
          EDAll
        );
    ...
    Init: function Init(a) {
      ...
      (!a || !a.FlagToEnd) &&
        (r.FlagToEnd = function () {
          NewImg(
            "1imgSF",
            "exp/game4/images/interface/PVE_Won.png",
          ...
          NewImg(
            "imgSF",
            "exp/game4/images/interface/PassLevel_Continue.png",
  ...
  QinBossZ = function QinBossZ() {
    ...
    NewImg(
      "boss0",
      "exp/game4/images/interface/Qin_Boss_Atk.gif",
    ...
    oSym.addTask(
      ...
      function () {
        ...
        NewImg(
          "boss0",
          "exp/game4/images/interface/Qin_Boss_Idle.gif",
          "left:627px;top:128px;z-index:254",
          EDAll
        );
      },
  ...
  QinBossK = function QinBossK() {
    ...
    NewEle(
      0,
      "div",
      "width:1400px;height:600px;margin:0px 0 0 0px;position:absolute;z-index:1;background:url(exp/game4/images/interface/background5.jpg)",
      0,
      $("tGround")
    );
    var a = oMudBreak;
  ...
  QinBossDie = function QinBossDie() {
    ...
    NewImg(
      "boss5",
      "exp/game4/images/interface/Qin_Boss_Die.gif",
      "left:627px;top:128px;z-index:254",
      EDAll
    );
    NewImg(
      "bossshadow2",
      "exp/game4/images/interface/Qin_Boss_Die_BlackHole.png",
  ...
  Almanac = {
    Init: function Init() {
      ...
      NewEle("dHandBook", "div", 0, 0, document.body, {
        ...
        '<div class="title">图鉴——索引</div><div class="content"><div><img border="0" src="exp/game4/images/Plants/SunFlower/0.gif" width="73" height="74"><br><input class="button" type="button" value="查看植物" name="btnViewPlant" id="btnViewPlant" onclick="Almanac.InitHandBookPCard()"> </div><div style="left:50%;padding-top:95px"><img border="0" src="exp/game4/images/Zombies/Zombie/0.gif" width="149" height="130"><br><input class="button" type="button" value="查看僵尸" name="btnViewZombie" id="btnViewZombie" onclick="Almanac.InitHandBookZCard()"> </div></div><div class="close" onmouseover="this.style.backgroundPosition=\'bottom\'" onmouseout="this.style.backgroundPosition=\'top\'" onclick="Almanac.CloseHandBook()">关 闭&nbsp;</div>'; //植物和僵尸图鉴
  ...
  ChoseShovel = function ChoseShovel(a) {
    ...
    WhichMouseButton(a) < 2 &&
      ...
      NewImg(
        "tShovel",
        "exp/game4/images/interface/Shovel.png",
        "left:" +
          (a.clientX - 10) +
          "px;top:" +
  ...
  AppearSun = function AppearSun(h, f, e, a) {
    ...
    NewImg(g, "exp/game4/images/interface/Sun.gif", c, EDAll, {
      onclick: function onclick() {
        ClickSun(this.id);
      }
    });
  ...
  ShowLargeWave = function ShowLargeWave(a) {
    ...
    NewImg(
      "LargeWave",
      "exp/game4/images/interface/LargeWave.gif",
  ...
  ShowFinalWave = function ShowFinalWave() {
    var a = function a(b) {
      ...
      NewImg(
        "FinalWave",
        "exp/game4/images/interface/FinalWave.gif",
  ...
  GameOver = function GameOver() {
    ...
    NewImg(
      "iGameOver",
      "exp/game4/images/interface/ZombiesWon.jpg",
  ...
  LoseMower = function LoseMower() {
    ...
    NewImg(
      "iGameOver",
      "exp/game4/images/interface/LoseMower.jpg",
      "width:900px;height:600px;z-index:255",
      EDAll,
      {
        onclick: function onclick() {
      ...
      oSym.addTask(
        ...
        [
          NewEle(
            0,
            "div",
            "position:absolute;overflow:hidden;background:url(exp/game4/images/interface/PrepareGrowPlants.png) no-repeat;width:255px;height:108px;z-index:50;left:" +
              (oS.W * 0.5 - 77) +
              "px;top:" +
              (oS.H * 0.5 - 54) +
              "px",
...
(Date.prototype.format = function (b) {
  ...
  (StartAdventure = (function (_StartAdventure) {
    ...
    var c = $("ZombieHand"),
      ...
      a = NewImg(
        "",
        "exp/game4/images/interface/ZombieHand.png",
