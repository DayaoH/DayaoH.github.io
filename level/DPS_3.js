oS.Init({
  ...
  CanSelectCard: 1,
  LevelName: $__language_Array__["29997d11a6e377ae65c80e2e43b6073c"],
  SunNum: 350,
  LvlEName: 3,
  LoadMusic: "Lg_11",
  ...
  AZ: [[oSeaBasic, 5, 1], [oSeaShrimp, 3, 3], [oSeaConch, 6, 5], [oSeaGui, 2, 9], [oSeaFlag, 2, 10], [oSeaJelly, 2, 10]],
  FlagNum: 15,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15],
    a2: [4, 3, 2, 4, 5, 6, 7]
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/LG_NEWIMG/Card/Litchi_Compressed.png", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
