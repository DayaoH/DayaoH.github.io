oS.Init({
  PName: [oPeashooter, oSunFlower, oWallNut, oPuffShroom, oFumeShroom, oScaredyShroom, oLotus, oBamboo, oCGTree, oCactus, oGloomShroom, oPrimnalPea, oPrimnalSun],
  ...
  LevelName: $__language_Array__["c9d562626fce4654c01a23a14aeb4f5a"],
  SunNum: 100,
  LvlEName: 2,
  LoadMusic: "Dino1",
  ...
  AZ: [[oDinoZombie, 1, 1], [oDinoConeheadZombie, 3, 5], [oDinoBucketheadZombie, 1, 5], [oDinoTombZombie, 1, 15]],
  FlagNum: 11,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/Card/Plants/PrimnalNut.png", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
