oS.Init({
  ...
  ZName: [oSeaConch, oSeaFlag, oDPSeaJelly, oSeaXie, oSeaGui, oSeaJelly],
  PicArr: function () {
  ...
  CanSelectCard: 1,
  LevelName: $__language_Array__["2019dca9fad9568f4c64d6155ba18f0e"],
  SunNum: 350,
  LvlEName: 3,
  LoadMusic: "Lg_11",
  ...
  AZ: [[oSeaGui, 3, 5], [oSeaConch, 6, 1], [oSeaXie, 6, 3], [oSeaFlag, 2, 9], [oSeaJelly, 2, 9], [oDPSeaJelly, 2, 10]],
  FlagNum: 15,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15],
    a2: [1, 3, 6, 8, 2, 8, 9]
