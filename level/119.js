oS.Init({
  ...
  ZName: [oBalloonZombie, osZombie, oscZombie],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["87b90ce6e104e92b1621c6b916a449a4"],
  SunNum: 675,
  LvlEName: 4,
  ...
  AZ: [[osZombie, 2, 1], [oscZombie, 1, 1], [oBalloonZombie, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
