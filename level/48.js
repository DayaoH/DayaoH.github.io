oS.Init({
  ...
  ZName: [oFutureZombie, oShield, oJetPack],
  PicArr: function () {
  ...
  CanSelectCard: 1,
  DKind: 0,
  LevelName: $__language_Array__["16bbcf889b99314f8178a2f86f0dc8f5"],
  SunNum: 150,
  LvlEName: 2,
    ...
    (function (d) {
      ...
      switch (d) {
        case 0:
          ...
          innerText(c, $__language_Array__["4c8104443b030f6b3aec7e6549329807"]);
          break;
        ...
        case 1:
          ...
          innerText(c, $__language_Array__["5d9882001d7f36366fd79d75de6be99a"]);
          break;
        ...
        case 2:
          ...
          innerText(c, $__language_Array__["dbc9477de4eb748d37195da26a133ba3"]);
          break;
        ...
        case 3:
          ...
          innerText(c, "Noooooooooooooooooo!!!");
          break;
  ...
  AZ: [[oFutureZombie, 3, 1], [oJetPack, 3, 15], [oShield, 1, 10]],
  FlagNum: 20,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15, 19],
    a2: [3, 5, 6, 13, 6, 7, 16, 19]
  },
  FlagToMonitor: {
    9: [ShowLargeWave, 0],
    19: [ShowFinalWave, 0]
