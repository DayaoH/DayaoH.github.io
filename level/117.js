oS.Init({
  ...
  ZName: [oLostCityZombie, oBalloonZombie, osZombie, oscZombie],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["cc426c24a2997c4de64546edbff89f94"],
  SunNum: 675,
  LvlEName: 4,
  ...
  AZ: [[osZombie, 2, 1], [oscZombie, 1, 1], [oLostCityZombie, 1, 1], [oBalloonZombie, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
