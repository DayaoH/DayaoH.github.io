oS.Init({
  ...
  ZName: [oLostCityZombie, oSeaConch],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["c77e370033a49bc207b811be1bed230d"],
  SunNum: 375,
  LvlEName: 4,
  ...
  AZ: [[oLostCityZombie, 2, 1], [oSeaConch, 1, 1]],
  FlagNum: 19,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    NewImg("imgSF", "images/Card/Plants/A-CoiRock.png", "left:243px;top:410px;clip:rect(auto,auto,121px,auto)", EDAll, {
      onclick: function () {
        GetNewCard(this, oSpikerock, 105);
      }
    });
  }
});