oS.Init({
  PName: [oFirePea, oGarlic, oFirePea1],
  ZName: [oJWZ, oZombie, oZombie2, oZombie3],
  PicArr: ["images/interface/BackgroundEgyptSea.jpg", "images/interface/trophy.png"],
  backgroundImage: "images/interface/BackgroundEgyptSea.jpg",
  CanSelectCard: 0,
  LevelName: $__language_Array__["b1e0f236166960de258550b27219e3dc"],
  LvlEName: 10,
  LargeWaveFlag: {
    10: $("imgFlag3"),
    20: $("imgFlag1")
      ...
      oP.Monitor({
        f: function () {
          (function () {
            ...
            oSym.addTask(700, arguments.callee, []);
          })();
  ...
  AZ: [[oJWZ, 2, 1], [oZombie, 2, 1], [oZombie2, 1, 1], [oZombie3, 1, 1]],
  FlagNum: 20,
  FlagToSumNum: {
