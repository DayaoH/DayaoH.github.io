oS.Init({
  ...
  ZName: [oBucketheadZombie, oBalloonZombie],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["12b4a4581976fa39958d2b7abdb11ed6"],
  SunNum: 675,
  LvlEName: 4,
  ...
  AZ: [[oBucketheadZombie, 1, 1], [oBalloonZombie, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
