oS.Init({
  PName: [oShrubbery, oLaserBean1, oFD, oLavaGrava],
  ZName: [oDinoConeheadZombie, oDinoBucketheadZombie],
  PicArr: ["images/interface/DINO.png", "images/interface/trophy.png"],
  backgroundImage: "images/interface/DINO.png",
  CanSelectCard: 0,
  LevelName: $__language_Array__["6738b52db30ee6303329e60705419db1"],
  LvlEName: 10,
    ...
    (function (d) {
      ...
      switch (d) {
        case 0:
          ...
          innerText(c, $__language_Array__["1a79f9f82620fc70dfadcc689aee056d"]);
          break;
        ...
        case 1:
          ...
          innerText(c, $__language_Array__["eca1df389a4b05588dd9b8031b02754e"]);
          break;
        ...
        case 2:
          ...
          innerText(c, $__language_Array__["94fb7afab3198c36741795799d945990"]);
          break;
        ...
        case 3:
          ...
          innerText(c, $__language_Array__["ff1b0b825c6afb9caa9c9c864a747c3a"]);
          break;
      ...
      oP.Monitor({
        f: function () {
          (function () {
            ...
            if (a < 10) {
              var c = [oShrubbery, oLaserBean1, oFD, oLavaGrava],
  ...
  AZ: [[oDinoConeheadZombie, 4, 1], [oDinoBucketheadZombie, 3, 1]],
  FlagNum: 20,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/Card/Plants/PrimnalPotatoMine.png", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
