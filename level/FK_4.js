oS.Init({
  PicArr: function () {
    a = "images/interface/";
    return [ShadowPNG, a + "ChoseLevel_BG.png", a + "ChoseLevel_Common.png", a + "MaoXian_5_4.png", a + "Maoxian_Lv1.png", a + "Maoxian_Lv2.png", a + "Maoxian_Lv3.png"];
  }(),
  LevelName: $__language_Array__["7f3b0724a1040420bba48103b7e78947"],
  LevelEName: 1,
  ShowScroll: 1,
  ...
  LoadAccess: function (a) {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv11.png", "left:430px;top:224px", EDAll, {
      onclick: function () {
        ...
        NewImg("1imgSF", "images/interface/Zombie/4_7.png", "left:441px;top:313px;z-index:555", EDAll, {});
        NewImg("1imgSF", "images/interface/Zombie/4_8.png", "left:543px;top:313px;z-index:555", EDAll, {});
        NewImg("1imgSF", "images/interface/Zombie/4_9.png", "left:644px;top:313px;z-index:555", EDAll, {});
        NewImg("1imgSF", "images/interface/Zombie/5_1.png", "left:338px;top:396px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/Act_Cl.png", "left:721px;top:27px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv12.png", "left:618px;top:155px", EDAll, {
      onclick: function () {
        ...
        NewImg("1imgSF", "images/interface/Zombie/4_8.png", "left:338px;top:396px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/Act_Cl.png", "left:721px;top:27px;z-index:555", EDAll, {
          onclick: function () {
            SelectModal("FK_4");
          }
