oS.Init({
  ...
  ZName: [oDuckyTubeZombie1, oDuckyTubeZombie2, oDuckyTubeZombie3, oSeaJelly],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["2d6e19dffd74a7632a2f6385d59499e4"],
  SunNum: 675,
  LvlEName: 4,
  ...
  AZ: [[oSeaJelly, 2, 1], [oDuckyTubeZombie2, 1, 1], [oDuckyTubeZombie1, 1, 1], [oDuckyTubeZombie3, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
  ...
  FlagToEnd: function () {
    NewImg("imgSF", "images/Card/Plants/A-CoiA.png", "left:243px;top:410px;clip:rect(auto,auto,121px,auto)", EDAll, {
      onclick: function () {
        GetNewCard(this, oPrimnalPotatoMine, 130);
      }
    });
  }
});