oS.Init({
  ...
  ZName: [oSeaGui, oSeaBasic, oSeaJelly, oSeaConch, oSeaShrimp],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["6bf74273a3397b8f56e5eaaf61af710c"],
  SunNum: 300,
  LvlEName: 8,
  ...
  AZ: [[oSeaJelly, 1, 1], [oSeaGui, 1, 1], [oSeaBasic, 4, 1], [oSeaShrimp, 1, 1], [oSeaConch, 2, 1]],
  FlagNum: 12,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/LG_NEWIMG/Card/ThunderPine_Compressed.png", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
