oS.Init({
  PName: [oPuffShroom, oPuffShroom1, oSunFlower, oPeashooter, oBB],
  ZName: [oBeachZombie, oPOIZombie, oWZZombie, oBull],
  PicArr: ["images/interface/summer.jpg"],
  backgroundImage: "images/interface/summer.jpg",
  CanSelectCard: 0,
  DKind: 0,
  SunNum: 50,
  LevelName: $__language_Array__["14754849b377e4b174b95218f00688ff"],
  LvlEName: 11,
  LargeWaveFlag: {
    10: $("imgFlag3"),
    20: $("imgFlag1")
  ...
  AZ: [[oBeachZombie, 2, 1], [oPOIZombie, 1, 1], [oWZZombie, 1, 1], [oBull, 1, 1]],
  FlagNum: 20,
  FlagToSumNum: {
