oS.Init({
  ...
  ZName: [oSeaJelly, oDolphinRiderZombie, oSnorkelZombie],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["5832e97d4b1d6a31589687d6344e5f6d"],
  SunNum: 675,
  LvlEName: 4,
  ...
  AZ: [[oDolphinRiderZombie, 2, 1], [oSnorkelZombie, 2, 1], [oSeaJelly, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
