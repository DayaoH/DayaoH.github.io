oS.Init({
  PName: [oPeashooter, oSunFlower, oOxygen, oShuilei, oTwinSunflower, oFumeShroomSong, oFumeShroom, oScaredyShroom],
  ZName: [oSeaConch, oSeaBasic, oSeaShrimp, oSeaXie, oSeaFlag, oSeaGui],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["d5d88e2fb8f7ed2199dc4599d83af1cb"],
  SunNum: 300,
  LvlEName: 5,
  ...
  AZ: [[oSeaXie, 1, 1], [oSeaShrimp, 1, 1], [oSeaBasic, 4, 1], [oSeaConch, 2, 1], [oSeaFlag, 1, 1], [oSeaGui, 1, 1]],
  FlagNum: 42,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/LG_NEWIMG/Card/BubbleFlower_Compressed", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
