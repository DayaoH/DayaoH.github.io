oS.Init({
  PName: [oPeashooter, oLavaGrava, oStallia],
  ZName: [oBeachZombie, oPZombie, ograve],
  PicArr: ["images/interface/summer1.jpg", "images/interface/trophy.png"],
  backgroundImage: "images/interface/summer1.jpg",
  CanSelectCard: 0,
  LevelName: $__language_Array__["0c4c592e4ec05bcd2bdd3ddd8728b435"],
  LvlEName: "11",
  DKind: 0,
  LargeWaveFlag: {
    10: $("imgFlag3"),
  ...
  AZ: [[oBeachZombie, 1, 1], [oPZombie, 1, 1]],
  //僵尸的数量
  FlagNum: 10,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15, 19],
    a2: [1, 2, 3, 15, 12, 18, 24, 30]
  },
  FlagToMonitor: {
    9: [ShowLargeWave, 0],
    19: [ShowFinalWave, 0]
