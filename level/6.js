oS.Init({
  PName: [oPeashooter, oOxygen, oBubbleFlower, oShuilei],
  ZName: [oSeaBasic, oSeaConch, oSeaGui],
  PicArr: ["images/LG_NEWIMG/background.png", "images/interface/trophy.png"],
  LF: [0, 3, 3, 3, 3, 3],
  backgroundImage: "images/LG_NEWIMG/background.png",
  CanSelectCard: 0,
  LevelName: $__language_Array__["0f896a6340674a60379a31985e1d0126"],
  LvlEName: 6,
  ...
  AZ: [[oSeaBasic, 5, 1], [oSeaGui, 2, 1], [oSeaConch, 2, 1]],
  FlagNum: 20,
  FlagToSumNum: {
