oS.Init({
  PName: [oPeashooter, oSunFlower, oWallNut, oPuffShroom, oFumeShroom, oScaredyShroom, oLotus, oBamboo, oCGTree, oCactus, oGloomShroom, oPrimnalPea, oPrimnalSun, oPrimnalNut, oColdnap, oPrimnalPotatoMine],
  ...
  CanSelectCard: 1,
  DKind: 0,
  LevelName: $__language_Array__["4f23650c241c0b5b35fa359d0ff69d30"],
  SunNum: 150,
  LvlEName: 2,
    ...
    (function (d) {
      ...
      switch (d) {
        ...
        case 1:
          ...
          innerText(c, $__language_Array__["4316df67dcaa4945d82436589cd3b6b6"]);
          break;
        ...
        case 2:
          ...
          innerText(c, $__language_Array__["378a0a1f30741de8f3dee22acd16d5a2"]);
          break;
        ...
        case 3:
          ...
          innerText(c, $__language_Array__["0944fc7a1e5090a4b1c56d7029a2eac0"]);
          break;
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/LG_NEWIMG/Card/LaserPea.png", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
