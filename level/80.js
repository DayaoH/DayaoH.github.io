oS.Init({
  PicArr: function () {
    a = "images/interface/";
    return [ShadowPNG, a + "ChoseLevel_BG.png", a + "ChoseLevel_Common.png", a + "MaoXian_1_3.jpg", a + "Maoxian_Lv1.png", a + "Maoxian_Lv2.png", a + "Maoxian_Lv3.png"];
  }(),
  LevelName: $__language_Array__["9afc987650bdcc221a2450fd500bcc85"],
  LevelEName: 1,
  ShowScroll: 1,
  backgroundImage: "images/interface/MaoXian_1_3.jpg",
  LoadAccess: function (a) {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv6_.png", "left:327px;top:169px", EDAll, {
      onclick: function () {
        ...
        NewImg("1imgSF", "images/interface/Zombie/1_6.png", "left:543px;top:313px;z-index:555", EDAll, {});
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv7.png", "left:542px;top:273px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv8.png", "left:745px;top:375px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("1imgSF", "images/LG_NEWIMG/PlantBubbleFlower/0.gif", "left:140px;top:211px", EDAll, {});
