oS.Init({
  PicArr: function () {
    a = "images/interface/";
    return [ShadowPNG, a + "ChoseLevel_BG.png", a + "ChoseLevel_Common.png", a + "MaoXian_5_1.png", a + "Maoxian_Lv1.png", a + "Maoxian_Lv2.png", a + "Maoxian_Lv3.png"];
  }(),
  LevelName: $__language_Array__["98c54ead325fcd8bdbcf679739eec64a"],
  LevelEName: 1,
  ShowScroll: 1,
  backgroundImage: "images/interface/MaoXian_5_1.png",
  LoadAccess: function (a) {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv1.png", "left:297px;top:305px", EDAll, {
      onclick: function () {
        ...
        NewImg("1imgSF", "images/interface/Zombie/4_5.png", "left:543px;top:313px;z-index:555", EDAll, {});
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv2.png", "left:564px;top:211px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
        ...
        NewImg("imgSF", "images/interface/Act_Cl.png", "left:721px;top:21px;z-index:555", EDAll, {
          onclick: function () {
            SelectModal("FK_1");
          }
        });
    ...
    NewImg("1imgSF", "images/Plants/LongAn/0.gif", "left:740px;top:85px", EDAll, {});
