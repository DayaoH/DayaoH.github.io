oS.Init({
  PicArr: function () {
    a = "images/interface/";
    return [ShadowPNG, a + "ChoseLevel_BG.png", a + "ChoseLevel_Common.png", a + "MaoXian_3_1.jpg", a + "Maoxian_Lv1.png", a + "Maoxian_Lv2.png", a + "Maoxian_Lv3.png"];
  }(),
  LevelName: $__language_Array__["9857a2f323f212e981c80e45f28222dd"],
  LevelEName: 1,
  ShowScroll: 1,
  backgroundImage: "images/interface/MaoXian_3_1.jpg",
  LoadAccess: function (a) {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv1.png", "left:361px;top:322px", EDAll, {
      onclick: function () {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv2.png", "left:800px;top:175px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("1imgSF", "images/Plants/PrimnalPea/0.gif", "left:603px;top:195px", EDAll, {});
