oS.Init({
  PicArr: function () {
    a = "images/interface/";
    return [ShadowPNG, a + "ChoseLevel_BG.png", a + "ChoseLevel_Common.png", a + "MaoXian_3_3.jpg", a + "Maoxian_Lv1.png", a + "Maoxian_Lv2.png", a + "Maoxian_Lv3.png"];
  }(),
  LevelName: "٪�޼�3",
  LevelEName: 1,
  ShowScroll: 1,
  backgroundImage: "images/interface/MaoXian_3_3.jpg",
  LoadAccess: function (a) {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv5.png", "left:12px;top:328px", EDAll, {
      onclick: function () {
        ...
        NewImg("1imgSF", "images/interface/Zombie/3_3.png", "left:543px;top:313px;z-index:555", EDAll, {});
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv6.png", "left:395px;top:156px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv7.png", "left:608px;top:262px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("1imgSF", "images/Plants/Shrubbery/0.gif", "left:734px;top:262px", EDAll, {});
    NewImg("1imgSF", "images/Plants/Coldnap/0.gif", "left:178px;top:180px", EDAll, {});
