oS.Init({
  ...
  ZName: [oBalloonZombie, osZombie, oscZombie, osbZombie],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["92b9a32d11ec610e509c02c9bdca70fa"],
  SunNum: 675,
  LvlEName: 4,
  ...
  AZ: [[osZombie, 2, 1], [oscZombie, 1, 1], [osbZombie, 1, 1], [oBalloonZombie, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
