oS.Init({
  PName: [oPeashooter, oSunFlower, oWallNut, oSnowPea, oFumeShroom, oStallia, oScaredyShroom, oFumeShroomSong, oTwinSunflower, oPuffShroom, oFD, oBB, oBamboo, oCGTree, oLotus, oCactus, oGloomShroom, oGarlic, oSpikerock, oPrimnalPea, oPrimnalNut, oColdnap, oShrubbery, oPrimnalSun, oLongAn, oNap, oTaro, oStarfruit, oStarfruit_T],
  ZName: [oDinoConeheadZombie1, oDinoBucketheadZombie1, oDinoCamelZombie, oDinoBossImp],
  PicArr: function () {
  ...
  CanSelectCard: 1,
  LevelName: $__language_Array__["758517a33c5d60c3a07085ee007ab63e"],
  SunNum: 350,
  LvlEName: 3,
  ...
  AZ: [[oDinoCamelZombie, 4, 5], [oDinoConeheadZombie1, 8, 1], [oDinoBucketheadZombie1, 2, 5], [oDinoBossImp, 1, 8]],
  FlagNum: 15,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15],
    a2: [3, 3, 5, 7, 5, 7, 10]
