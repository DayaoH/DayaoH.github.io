oS.Init({
  ...
  ZName: [oZombie, oConeheadZombie, oBucketheadZombie, oBalloonZombie],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["3d81faf2a70363d168839f2049d1d511"],
  SunNum: 375,
  LvlEName: 4,
  ...
  AZ: [[oZombie, 2, 1], [oConeheadZombie, 2, 1], [oBucketheadZombie, 1, 1], [oBalloonZombie, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13],
    a2: [1, 2, 3, 10, 4, 5]
