oS.Init({
  ...
  ZName: [oZombie, oConeheadZombie, oBucketheadZombie, oJWBZ],
  PicArr: function () {
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["3e9fc08269a3ab6d79bc7226f41aea4c"],
  SunNum: 375,
  LvlEName: 4,
  ...
  AZ: [[oZombie, 2, 1], [oConeheadZombie, 2, 1], [oBucketheadZombie, 1, 1], [oJWBZ, 1, 1]],
  FlagNum: 19,
  FlagToSumNum: {
