oS.Init({
  ...
  CanSelectCard: 1,
  DKind: 0,
  LevelName: $__language_Array__["d6bb6924170a94d2c1019123ca461ac0"],
  SunNum: 150,
  LvlEName: 2,
    ...
    (function (d) {
      ...
      switch (d) {
        case 0:
          ...
          innerText(c, $__language_Array__["a8feede21277044354c4f26b77b0e929"]);
          break;
        ...
        case 1:
          ...
          innerText(c, $__language_Array__["0c92359ed6b1be8d0ef61b8963339141"]);
          break;
        ...
        case 3:
          ...
          innerText(c, $__language_Array__["6a06ae95b449df55c548a747ce2279d9"]);
          break;
  ...
  AZ: [[oFutureZombie, 2, 1], [oHeadZombie, 4, 5], [oJetPack, 1, 4]],
  FlagNum: 20,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    ...
    NewImg("1imgSF", "images/Card/Plants/XiaoJinJu.png", "left:400px;top:300px;clip:rect(auto,auto,60px,auto);z-index:556", EDAll, {});
