oS.Init({
  ...
  ZName: [oSeaXie, oSeaGui, oSeaShrimp, oSeaConch, oSeaJelly, oSeaFlag],
  PicArr: function () {
  ...
  CanSelectCard: 1,
  LevelName: $__language_Array__["e75db9fae3504c68c6b04b16f96349cb"],
  SunNum: 350,
  LvlEName: 3,
  LoadMusic: "Lg_11",
  ...
  AZ: [[oSeaGui, 5, 10], [oSeaShrimp, 3, 1], [oSeaConch, 6, 5], [oSeaXie, 2, 9], [oSeaFlag, 2, 10], [oSeaJelly, 2, 10]],
  FlagNum: 15,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15],
    a2: [3, 3, 5, 5, 7, 7, 10]
