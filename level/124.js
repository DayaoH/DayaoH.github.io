oS.Init({
  ...
  CanSelectCard: 0,
  LevelName: $__language_Array__["aa34d5b4d67ef873cffd9cb396425a43"],
  LvlEName: 20,
  LargeWaveFlag: {
    13: $("imgFlag1")
  },
  ...
  AZ: [[oBucketheadZombie, 2, 1], [oBull, 1, 1]],
  FlagNum: 13,
  FlagToSumNum: {
  ...
  FlagToEnd: function () {
    NewImg("imgSF", "images/Card/Plants/A-CoiKelp.png", "left:243px;top:410px;clip:rect(auto,auto,121px,auto)", EDAll, {
      onclick: function () {
        GetNewCard(this, oTangleKlep, 125);
      }
    });
  }
});