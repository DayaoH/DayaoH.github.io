oS.Init({
  ...
  ZName: [oDinoConeheadZombie1, oDinoZombie1, oDinoCamelZombie, oDinoBossImp],
  PicArr: function () {
  ...
  CanSelectCard: 1,
  LevelName: $__language_Array__["7101d33ec02971decb3cddd73378c6c5"],
  SunNum: 350,
  LvlEName: 3,
  ...
  AZ: [[oDinoCamelZombie, 4, 5], [oDinoConeheadZombie1, 8, 1], [oDinoZombie1, 2, 5], [oDinoBossImp, 1, 8]],
  FlagNum: 15,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15],
    a2: [3, 3, 5, 7, 5, 7, 10]
