oS.Init({
  ...
  ZName: [oSeaBasic, oSeaShrimp, oSeaConch, oSeaFlag, oDPSeaJelly],
  PicArr: function () {
  ...
  CanSelectCard: 1,
  LevelName: $__language_Array__["2f88cc6c4acf06ea5b7fa11525519537"],
  SunNum: 350,
  LvlEName: 3,
  LoadMusic: "Lg_11",
  ...
  AZ: [[oSeaBasic, 5, 1], [oSeaShrimp, 3, 1], [oSeaConch, 6, 5], [oSeaFlag, 2, 9], [oDPSeaJelly, 2, 10]],
  FlagNum: 15,
  FlagToSumNum: {
    a1: [3, 5, 9, 10, 13, 15],
    a2: [1, 3, 6, 8, 2, 8, 9]
