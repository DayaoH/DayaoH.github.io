oS.Init({
  PicArr: function () {
    a = "images/interface/";
    return [ShadowPNG, a + "MaoXian_1_1.jpg", a + "Maoxian_Lv1.png", a + "Maoxian_Lv2.png", a + "Maoxian_Lv3.png", a + "ChoseLevel_BG.png", a + "ChoseLevel_Common.png"];
  }(),
  LevelName: $__language_Array__["5110481b589c6595a25f5593fd875f41"],
  LevelEName: 1,
  ShowScroll: 1,
  backgroundImage: "images/interface/MaoXian_1_1.jpg",
  LoadAccess: function (a) {
    NewImg("imgSF", "images/interface/Maoxian_Lv1.png", "left:312px;top:331px", EDAll, {
      onclick: function () {
    ...
    NewImg("imgSF", "images/interface/Maoxian_Lv2.png", "left:761px;top:179px", EDAll, {
      onclick: function () {
        NewImg("1imgSF", "images/interface/ChoseLevel_BG.png", "left:0px;top:0px;z-index:555", EDAll, {});
        NewImg("imgSF", "images/interface/ChoseLevel_Common.png", "left:464px;top:504px;z-index:555", EDAll, {
          onclick: function () {
    ...
    NewImg("1imgSF", "images/LG_NEWIMG/PlantOxygen/1.gif", "left:551px;top:185px", EDAll, {});
