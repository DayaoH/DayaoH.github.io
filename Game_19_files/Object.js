...
var $User = (function () {
    ...
    return {
      ...
      Server: {
        List: [
          ["1号", "https://web.archive.org/web/20240901141753/http://pvz1.lonelystar.org/", "NaN"],
          ["2号", "https://web.archive.org/web/20240901141753/http://pvz2.lonelystar.org/", "NaN"]
        ],
        SpeedURL: "",
        DataURL: "",
        SpeedInx: 0,
  ...
  oS = {
    ...
    LoadTips: function LoadTips() {
      var b = NewEle(
          "dTips",
          "div",
          "position:absolute;color:#fff;top:450px;width:100%;text-align:center;font-size:30px;font-family:方正准圆简体",
          "",
          EDAll
        ),
        a = ["正在加载图片资源"];
      b.innerHTML =
        '<img src="images/interface/Flower.gif" style="position:absolute;top:0%;left:0%;transform:translateX(280px) translateY(-300px);pointer-events:none;"><span style="font-weight:bold"></span><span>' +
    ...
    CheckImg: function CheckImg(b, a) {
      ...
      $("sFlagMeterTitleF").innerHTML =
        '<span style="cursor:pointer;font-family:Yahei Mono;color:#fff">正在下载图片资源(' +
        c.AccessNum +
        "/" +
        c.PicNum +
        ")</span>";
    ...
    LoadReady: function LoadReady(f) {
      ...
      if (f.CenterContent) {
        ...
        $("dAdFlash").innerHTML =
          ...
          Math.random() +
          '"></iframe><br><div style="font-family:arial,sans-serif;font-size:11px;position:absolute;left:300px;width:200px"></div>';
          ...
          ? oSym.addTask(
              ...
              [
                NewEle(
                  "DivParty",
                  "div",
                  "line-height:50px;color:#FFFFFF;font-size:50px;font-family:微软雅黑",
                  {
                    innerHTML:
                      (Math.floor(g.UserAuthority) == "255"
                        ? '<span style="color:#CE9A00;font-size:40px">&lt;' +
                          g.UserName +
                          "&gt;</span>"
                        : "&lt;" + g.UserName + "&gt;") + "的时空旅行！"
                  },
  ...
  oCoord = {
    ...
    2: function _() {
      ...
      oS.GifHTML =
        '<img style="position:absolute;left:0px;top:0px" src="images/xiyoures/background' +
        (oS.DKind ? 3 : 4) +
        '_.gif">';
  ...
  operateDynamicDifficulty = function operateDynamicDifficulty(val,absolute,noCorrect) {
    ...
    //动态难度设置
    var num =
      Number.parseInt(getCookie("JNG_ZL_DYNAMIC_DIFFICULTY_WINRATE")) || 0;
    ...
    Init: function Init(a) {
      ...
      if (a) {
        ...
        if (oS.DynamicDifficulty) {
          ...
          for (var _i3 = 0; _i3 < oP.FlagToSumNum.a2.length; _i3++) {
            ...
            oP.FlagToSumNum.a2[_i3] += calcFunc(
              _i3 - 1 >= 0 ? oP.FlagToSumNum.a1[_i3 - 1] : 0,
              _i3 >= oP.FlagToSumNum.a1.length
                ? oP.FlagNum
                : oP.FlagToSumNum.a1[_i3]
            );
            oP.FlagToSumNum.a2[_i3] = Math.round(
              oP.FlagToSumNum.a2[_i3] * (1 + operateDynamicDifficulty() / 7)
            );
      ...
      (!a || !a.FlagToEnd) &&
        (r.FlagToEnd = function () {
          NewImg(
            "1imgSF",
            "images/interface/PVE_Won.png",
            "left:0px;top:0px;z-index:555",
            EDAll,
            {}
          );
          NewImg(
            "imgSF",
            "images/interface/PassLevel_Continue.png",
            "left:357px;top:490px;z-index:557",
            EDAll,
            {
  ...
  QinBossZ = function QinBossZ() {
    ...
    NewImg(
      "boss0",
      "images/interface/Qin_Boss_Atk.gif",
      "left:627px;top:128px;z-index:254",
      EDAll
    );
    oSym.addTask(
      300,
      function () {
        ...
        NewImg(
          "boss0",
          "images/interface/Qin_Boss_Idle.gif",
          "left:627px;top:128px;z-index:254",
          EDAll
        );
      },
  ...
  QinBossK = function QinBossK() {
    ...
    NewEle(
      0,
      "div",
      "width:1400px;height:600px;margin:0px 0 0 0px;position:absolute;z-index:1;background:url(images/interface/background5.jpg)",
      0,
      $("tGround")
    );
    var a = oMudBreak;
  ...
  QinBossDie = function QinBossDie() {
    ...
    NewImg(
      "boss5",
      "images/interface/Qin_Boss_Die.gif",
      "left:627px;top:128px;z-index:254",
      EDAll
    );
    NewImg(
      "bossshadow2",
      "images/interface/Qin_Boss_Die_BlackHole.png",
      "left:707px;top:152px",
      EDAll
    );
    oSym.addTask(
      500,
  ...
  PZCard = {
    Init: function Init() {
      ...
      this.PData =
        ...
        (_this$PData["54"] = oyangqizao),
        (_this$PData[55] = oBL),
        (_this$PData[56] = oDandelion),
        (_this$PData[57] = oTileTurnip),
        (_this$PData[58] = oLittleCherry),
        (_this$PData[59] = oDirtyApple),
        (_this$PData[60] = oTangleKlep),
        (_this$PData[61] = oMushroom),
        (_this$PData[62] = oFumeShroomSong),
        (_this$PData[63] = oXshot),
        (_this$PData[64] = oLavaGrava),
        (_this$PData[65] = oBubbleFlower),
        (_this$PData[66] = oThunderPine),
        (_this$PData[67] = oOxygen),
        (_this$PData[68] = oShuilei),
        (_this$PData[69] = oMagicShroom),
        (_this$PData[70] = oRoseMan),
        (_this$PData[71] = oLaserBean),
        (_this$PData[72] = oFD),
        (_this$PData[78] = oLitchi),
        (_this$PData[79] = oBB),
        (_this$PData[80] = oStallia),
        (_this$PData[81] = oBamboo),
        (_this$PData[82] = oCGTree),
        (_this$PData[83] = oLotus),
        (_this$PData[84] = oCactus),
        (_this$PData[85] = oPlantern),
        (_this$PData[86] = oBlueBerry),
        (_this$PData[87] = oaneone),
        (_this$PData[88] = oPrimnalPea),
        (_this$PData[89] = oPrimnalNut),
        (_this$PData[90] = oColdnap),
        (_this$PData[91] = oShrubbery),
        (_this$PData[92] = oXiaoLaserBean),
        (_this$PData["Bow_0"] = oNutBowling),
        (_this$PData["Bow_1"] = oHugeNutBowling),
        (_this$PData["Bow_2"] = oBoomNutBowling),
        _this$PData);
      this.ZData = {
        0: oZombie,
        1: oFlagZombie,
  ...
  Almanac = {
    ...
    InitHandBookPCard: function InitHandBookPCard() {
      ...
      while (i < L) {
        AlPInx.substr(i, 1) == 1
          ? ((EName = (Pro = (P = PData[i]).prototype).EName),
            (s +=
              '<div class="span1" onclick="Almanac.ViewProducePlant(' +
              EName +
              ')"><img src="' +
              Pro.PicArr[0] +
              '"><div class="span2">' +
    ...
    InitHandBookZCard: function InitHandBookZCard() {
      ...
      while (i < L) {
        AlZInx.substr(i, 1) == 1
          ? ((EName = (Pro = (P = ZData[i]).prototype).EName),
            (s +=
              '<div class="span1" onclick="Almanac.ViewProduceZombie(' +
              EName +
              ')"><img src="' +
              Pro.PicArr[0] +
              '"><div class="span2">' +
    ...
    ViewProducePlant: function ViewProducePlant(o) {
      ...
      $("pHandBookPlant").style.backgroundImage =
        "url(" + Pro.PicArr[Pro.StaticGif] + ")";
      $("pHandBookPlant").style.backgroundPosition =
        "50% " + (90 - (Pro.height + Pro.GetDTop) * 0.5) + "px";
      $("dProducePlant").innerHTML = Pro.Produce;
      innerText($("dHandBookPlantName"), Pro.CName);
      innerText($("spSunNum"), Pro.SunNum + "点");
      innerText($("spCoolTime"), Pro.coolTime + "秒");
      innerText($("spHP"), Pro.HP + "点");
      innerText($("spRange"), Pro.Range);
      $("pPlantBack").style.backgroundPosition =
        -200 * Pro.BookHandBack + "px 0";
    },
    ViewProduceZombie: function ViewProduceZombie(o) {
      ...
      $("pHandBookZombie").style.background =
        "url(" +
        Pro.PicArr[Pro.StaticGif] +
        ") no-repeat scroll " +
        Pro.BookHandPosition;
    ...
    Check: function Check(PAr, ZAr) {
      ...
      for (i = 0; i < l; i++) {
        if (!isNaN((n = PAr[i])) && AlPInx.substr(n, 1) != 1)
          AlPInx =
            (n > 0 ? AlPInx.substr(0, n) : "") +
            1 +
            AlPInx.substring(n + 1, Inx);
      }
      ...
      for (i = 0; i < l; i++) {
        if (!isNaN((n = ZAr[i])) && AlZInx.substr(n, 1) != 1)
          AlZInx =
            (n > 0 ? AlZInx.substr(0, n) : "") +
            1 +
            AlZInx.substring(n + 1, Inx);
      }
  ...
  InitHandBookZCard = function InitHandBookZCard() {
    ...
    var d = "",
      ...
      e = [
        ...
        oBucketheadZombie,
        oKungFuZombie,
        oKungFuConeheadZombie,
        oKungFuBucketheadZombie,
        oMonkZombie,
        oMonkConeheadZombie,
        oMonkBucketheadZombie,
        oKungFuBonk,
        oKungFuBomb,
        oKungFuDrum,
        oKungFuHuoBa
  ...
  ViewPlantTitle = function ViewPlantTitle(b) {
    ...
    !oS.CardKind &&
      ...
      !e.CDReady &&
        (a += '<br><span style="color:#F00">植物正在冷却中……</span>'));
    !e.SunReady && (a += '<br><span style="color:#F00">你的阳光不足!</span>');
    f.innerHTML = a;
    SetStyle(f, {
      top: 60 * b + 60 + "px",
    ...
    while (b--) {
      ...
      switch (a) {
        ...
        default:
            ...
            DoCoolTimer(b, firstCoolTime);  //注册计时器
      }
    }
  },
  ...
  GameOver = function GameOver() {
    ...
    NewImg(
      "iGameOver",
      "images/interface/ZombiesWon.jpg",
  ...
  YourPlantIsAte = function YourPlantIsAte() {
    ...
    NewImg(
      "iGameOver",
      "images/interface/YourPlantIsAte.jpg",
      "width:900px;height:600px;z-index:255",
      EDAll,
      {
        onclick: function onclick() {
  ...
  LoseMower = function LoseMower() {
    ...
    NewImg(
      "iGameOver",
      "images/interface/LoseMower.jpg",
      "width:900px;height:600px;z-index:255",
      EDAll,
      {
        onclick: function onclick() {
  ...
  ShowNameDiv = function ShowNameDiv() {
    ...
    (function (c) {
      ...
      while (d--) {
        //     SetStyle($("dNameDiv" + d).style.top = b[d] + "px")  //20150825
      }
...
CheckLogin = function() {
  ...
  SelectModal = function SelectModal(g) {
    ...
    if (oImage["garbage"]) {
      for (
        var _iterator = _createForOfIteratorHelperLoose(oImage["garbage"]),
          _step;
    ...
    !$("dText1") &&
      a.insertBefore(
        NewEle(
          ...
          0,
          {
            //innerHTML: '<span style="line-height:23px;font-size:15px;font-family:&#x9ED1;&#x4F53;;color:#F60;top:32px"><span style="font-family:Verdana;font-weight:700"></span><span style="font-family:Verdana;font-weight:700"></span></span><br><br><div style="text-align:center"><b><a style="color:#FF0;font-size:15px;text-decoration:none" href="https://web.archive.org/web/20240901141753/http://dwz.cn/pvz2js/" target="_blank">游戏网站</a>&nbsp;&nbsp;&nbsp;<a style="color:#FF0;font-size:15px;text-decoration:none" href="https://web.archive.org/web/20240901141753/http://blog.lonelystar.org/view" target="_blank">我要吐槽</a>&nbsp;&nbsp;&nbsp;<a href="https://web.archive.org/web/20240901141753/http://sunflower.lonelystar.org/tousu.html" target="_blank"  style="color:#FF0;font-size:15px;text-decoration: none">我要投诉</a></b></div>'
          },
          0
        ),
        a.firstChild
    ...
    (function () {
      ...
      d.src =
        ("https:" == document.location.protocol
          ? "https://web.archive.org/web/20240901141753/https://ssl"
          : "https://web.archive.org/web/20240901141753/http://www") + ".google-analytics.com/ga.js";
...
(Date.prototype.format = function (b) {
    ...
    ? function (json) {
        ...
        ele.preload =
          json.preload === undefined
            ? "auto"
            : ["auto", "meta", "none"][json.preload]; //加载方式
        ...
        json.callback &&
          ele.addEventListener("canplaythrough", json.callback, false);
        ...
        if (window.ResourcesDatabase && canXHR) {
          ...
          if (oAudioLink[src] && oAudioLink[src] != "loading") {
            ...
            //没有读取过尝试从数据库中读取
            getDataByKey(window.ResourcesDatabase, "audios", source).then(function (
              r
            ) {
              if (r) {
  ...
  (PlayAudio = $User.HTML5
    ? function (source, loop) {
        ...
        return audio
          ? ((audio.loop = loop), audio.play())
          : (_NewAudio = NewAudio({
              source: source,
              loop: loop,
              autoplay: true
            })) === null || _NewAudio === void 0
          ? void 0
          : _NewAudio.play();
      }
    : function () {}),
  ...
  (AllAudioPauseCanceled = $User.HTML5
    ? function () {
        ...
        while (a--) {
          ...
          (_oAudio$PausedAudioAr = oAudio[PausedAudioArr[a]]) === null ||
          _oAudio$PausedAudioAr === void 0
            ? void 0
            : _oAudio$PausedAudioAr.play();
        }

        PausedAudioArr.length = 0;
      }
    : function () {}),
  (AllAudioMuted = function AllAudioMuted() {
    var a;
...
var loadRes = function loadRes(ziyuanBiao, o) {
  ...
  ziyuanBiao.au &&
    ziyuanBiao.au.forEach(function (x) {
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 10.371
  LoadShardBlock: 1671.285 (3)
  PetaboxLoader3.datanode: 1536.645 (4)
  PetaboxLoader3.resolve: 174.915 (3)
  load_resource: 111.269
*/